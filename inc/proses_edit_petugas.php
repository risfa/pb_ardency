...
mysql_query("update tb_user set username = '$user', password = md5('$pass'), pass = '$pass', nama_lengkap = '$nm', jenis_kelamin = '$jk', alamat = '$alamat', no_telepon = '$tlp', keterangan = '$ket', level = '$level' where kode_user = '$id'") or die (mysql_error());
