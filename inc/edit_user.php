...
<legend>Edit Akun Admin</legend>
   ...
   <div class="form-group">
        ...
        <div class="col-md-4">
        <input type="text" id="pass" class="form-control" value="<?php echo $data['pass']; ?>" />
        </div>
    </div>
	<div class="form-group">
	...
	$("#edit").click(function() {
		...
		if(nm == '') {
			...
			$.ajax({
				...
				data : 'nm='+nm+'&user='+user+'&pass='+pass+'&jk='+jk+'&alamat='+alamat+'&tlp='+tlp+'&level='+level+'&ket='+ket+'&id=<?php echo $id; ?>',
