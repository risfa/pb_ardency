...
<fieldset>
	<legend>Input Data Penerimaan</legend>
    <form method="post" action="inc/proses_tambah_kas_penerimaan.php" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
        <i>Rp. </i>
        <input type="text" name="hj" id="hj" class="form-control" />
        </div>
    </div>
	...
	$("#tambah").click(function(){
		...
		else
		{
			$.ajax({
				type : 'post',
				url : 'inc/proses_tambah_kas_penerimaan.php',
