...
<div style="margin-top:10px;">
	...
	{
		?>
		<title>Laporan Keuangan PB Ardency</title>
		<fieldset class="utama">
			<h4>Laporan Keuangan PB Ardency</h4>
			<hr>
					...
					else
					{
						...
						while($data = mysql_fetch_array($sql))
						{
							...
							<tr>
								...
								<td style="border-right: 0; color: blue"><?php if($data[debit]!="" and $data[debit]!=0){echo"Rp.";} ?></td><td align="right" style="border-left:0; color: blue"><?php if($data[debit]!="" and $data[debit]!=0){echo number_format($data['debit'], 2, ".", ",");} ?></td>
								<td style="border-right: 0; color: red;"><?php if($data[kredit]!="" and $data[kredit]!=0){echo"Rp.";} ?></td><td align="right" style="border-left:0; color: red"><?php if($data[kredit]!="" and $data[kredit]!=0){echo number_format($data['kredit'], 2, ".", ",");} ?></td>
